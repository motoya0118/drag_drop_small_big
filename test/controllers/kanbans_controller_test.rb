...
class KanbansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kanban" do
    assert_difference('Kanban.count') do
      post kanbans_url, params: { kanban: { description: @kanban.description, name: @kanban.name } }
    end
  ...
  test "should update kanban" do
    patch kanban_url(@kanban), params: { kanban: { description: @kanban.description, name: @kanban.name } }
